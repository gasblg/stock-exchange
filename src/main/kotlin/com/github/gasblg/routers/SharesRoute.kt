...
import com.github.gasblg.db.SharesSchema
...
fun Route.sharesRoute() {

    val sharesSchema: SharesSchema by inject()
    ...
    get("/shares") {
        ...
        val pagedData =
            sharesSchema.getAll(pageParams = pageParams, sortColumn = sortColumn, sortOrder = sortOrder, lang = lang)
    ...
    get("/shares/{ticker}") {
        ...
        val response = sharesSchema.read(ticker, last, lang)
        if (response != null) {
